    ...
    def post_processing(self, batch_dict):
        ...
        for index in range(batch_size):
            ...
            if post_process_cfg.NMS_CONFIG.MULTI_CLASSES_NMS:
                ...
                if isinstance(post_process_cfg.SCORE_THRESH, list):
                    score_thresh_per_class = torch.tensor(post_process_cfg.SCORE_THRESH, device=label_preds.device)
                    score_thresh = score_thresh_per_class[(label_preds - 1).long()]
                else:
                    score_thresh = post_process_cfg.SCORE_THRESH
